...
import { ArrowRight, Save, User, Phone, Mail, MapPin, FileText, Clock, DollarSign, AlertCircle } from 'lucide-react';
  ...
  return (
    <AuthenticatedLayout>
      <PageHeader
        ...
        subtitle={`دەستکاریکردنی: ${customer.name}`}
      />

      <div className="max-w-4xl">
        {/* کارتەکانی زانیاری کڕیار */}
          ...
          <Card className="border border-blue-200 bg-blue-50">
            <div className="flex items-center gap-4 p-4">
              ...
              <div>
                ...
                <div className="font-medium text-blue-900">{formatDate(customer.created_at)}</div>
              </div>
            </div>
          </Card>
          ...
          <Card className="border border-yellow-100 bg-yellow-50">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h4 className="font-medium text-yellow-900">تێبینی گرنگ</h4>
                <p className="mt-1 text-sm text-yellow-700">
                  • دەستکاریکردنی زانیاری کڕیار کار دەکاتە سەر هەموو فرۆشتن و پارەدانی داواکراوەکانی داھاتوو
                  <br />
                  • ناو و ژمارە مۆبایل بە وردی دەستکاری بکە بۆ ئەوەی لە کاتی گەڕان دا بتوانرێت بدۆزرێتەوە
                  <br />
                  • قەرزەکانی کڕیار لەم پەڕەیەدا ناتوانرێت دەستکاری بکرێن. بۆ دەستکاریکردنی قەرز، پەڕەی فرۆشتن یان پارەدان بەکاربهێنە
                </p>
              </div>
            </div>
          </Card>
