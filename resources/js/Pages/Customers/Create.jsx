...
import { ArrowRight, Save, User, Phone, Mail, MapPin, FileText } from 'lucide-react';
  ...
  return (
    <AuthenticatedLayout>
      <PageHeader
        ...
        subtitle="زیادکردنی کڕیارێکی نوێ"
      />
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="mt-1 text-sm text-blue-700">
                  • ناوی کڕیار بە تەواوی داخڵ بکە بۆ ئەوەی لە کاتی گەڕان دا بتوانی بیدۆزیتەوە
                  <br />
                  • ژمارە مۆبایل بە فۆرماتی 07XX XXX XXXX داخڵ بکە
                  <br />
                  • ناونیشانی تەواو داخڵ بکە بۆ بارکردنی سەبەتەی کڕین
                </p>
              </div>
            </div>
          </Card>
