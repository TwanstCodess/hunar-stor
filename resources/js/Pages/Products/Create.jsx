...
import { ArrowRight, Save, AlertCircle, Upload, DollarSign } from 'lucide-react';
  ...
  return (
    <AuthenticatedLayout>
      <PageHeader
        ...
        subtitle="زیادکردنی بەرهەمێکی نوێ بە سیستەمی یەکە"
      />
            ...
            <Card className="border-green-200 bg-green-50">
              <div className="space-y-4">
                ...
                >
                  ...
                  {isSubmitting ? 'تکایە چاوەڕێ بکە...' : 'پاشەکەوتکردنی بەرهەم'}
                </button>
